...
<body>
    <form method="POST">
        <label >PROMO LEBARAN, SEMUA BARANG DENGAN HARGA DIATAS Rp. 30000 DISKON 7%, DIBAWAH Rp. 30000 DISKON 5%</label> <br><br>
    ...
    <?php
        if ($_POST):
            ...
            echo "Apakah konsumen member toko ? " .$member. "<br><br>";
            ...
            if($member === 'Ya'){
              $diskon_member = "0.05";
              echo "Diskon khusus member = " .$diskon_member. "<br>";
